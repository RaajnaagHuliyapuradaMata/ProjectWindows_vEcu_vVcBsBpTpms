...
/* #INCLUDES                                                                  */
/******************************************************************************/
#include "Types_ARA_SwcApplTpms.hpp"
#include "ARA_SwcApplTpms.hpp"
...
Type_Std_tValueReturn handle_rdc_hs_inaktivereignis_readdata_call                      (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_hs_inaktivereignis_type_st*            const));
Type_Std_tValueReturn handle_rdc_hs_kalibrierereignis_readdata_call                    (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_hs_kalibrierereignis_type_st*          const));
Type_Std_tValueReturn handle_rdc_messdatenblock_readdata_call                          (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_messdatenblock_type_st*                const));
Type_Std_tValueReturn handle_status_rdc_lesen_readdata_call                            (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_status_type_st*                        const));
Type_Std_tValueReturn handle_status_rdc_version_readdata_call                          (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_version_type_st*                           const));
Type_Std_tValueReturn handle_rdc_rid_akt_reifen_laufstrecke_lesen_readdata_call        (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rid_akt_reifen_laufstrecke_lesen_type_st*  const));
Type_Std_tValueReturn handle_rdc_rid_akt_reifen_qr_code_lesen_readdata_call            (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rid_akt_reifen_qr_code_lesen_type_st*      const));
Type_Std_tValueReturn handle_rdc_developer_data_lesen_readdata_call                    (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_developer_data_lesen_type_st*              const));
Type_Std_tValueReturn handle_rdc_erfs_tsa_daten_lesen_readdata_call                    (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_erfs_tsa_daten_lesen_type_st*              const));
Type_Std_tValueReturn handle_rdc_ext_park_supervision_lesen_readdata_call              (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_ext_park_supervision_lesen_type_st*        const));
Type_Std_tValueReturn handle_rdc_erfs_akt_reifen_eco_lesen_readdata_call               (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_erfs_akt_reifen_eco_lesen_type_st*         const));
Type_Std_tValueReturn handle_rdc_erfs_akt_reifen_lesen_readdata_call                   (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_erfs_akt_reifen_lesen_type_st*             const));
Type_Std_tValueReturn handle_rdc_rid_alte_reifen_laufstrecke_lesen_readdata_call       (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rid_alte_reifen_laufstrecke_lesen_type_st* const));
Type_Std_tValueReturn handle_rdc_rid_alte_reifen_qr_code_lesen_readdata_call           (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rid_alte_reifen_qr_code_lesen_type_st*     const));
Type_Std_tValueReturn handle_rdc_re_lesen_druckcodierung_readdata_call                 (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_re_lesen_druckcodierung_type_st*           const));
Type_Std_tValueReturn handle_rdc_anlernen_lokalisierung_readdata_call                  (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_anlernen_lokalisierung_lesen_type_st*      const));
Type_Std_tValueReturn handle_rdc_erfs_eco_tabelle_readdata_call                        (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_erfs_eco_tabelle_lesen_type_st*            const));
Type_Std_tValueReturn handle_rdc_hs_warnereignis_ruecknahme_readdata_call              (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_hs_warnereignis_ruecknahme_type_st*    const));
Type_Std_tValueReturn handle_rdc_hs_warnereignis_readdata_call                         (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_hs_warnereignis_type_st*               const));
Type_Std_tValueReturn handle_rdc_hs_warnereignis_weich_readdata_call                   (uint8* const Data, uint8_t (*api_dtms_diag_call)(Dtms_diag_rdc_hs_warnereignis_weich_type_st*         const));
Type_Std_tValueReturn handle_steuern_digital_rdc_writedata_call                        (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_digital_rdc_type_st*                          const, uint8_t*));
Type_Std_tValueReturn handle_steuern_radelektronik_vorgeben_writedata_call             (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_radelektronik_vorgeben_type_st*               const, uint8_t*));
Type_Std_tValueReturn handle_rdc_developer_config_writedata_call                       (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_rdc_developer_config_type_st*                 const, uint8_t*));
Type_Std_tValueReturn handle_rdc_erfs_developer_config_writedata_call                  (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_rdc_erfs_developer_config_type_st*            const, uint8_t*));
Type_Std_tValueReturn handle_rdc_erfs_eco_reifentabelle_vorgeben_writedata_call        (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_rdc_erfs_eco_reifentabelle_vorgeben_type_st*  const, uint8_t*));
Type_Std_tValueReturn handle_rdc_erfs_tsa_daten_vorgeben_writedata_call                (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_rdc_erfs_tsa_daten_vorgeben_type_st*          const, uint8_t*));
Type_Std_tValueReturn handle_rdc_erfs_eco_akt_reifen_pos_vorgeben_writedata_call       (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_rdc_erfs_eco_akt_reifen_pos_vorgeben_type_st* const, uint8_t*));
Type_Std_tValueReturn handle_rdc_erfs_eco_neue_reifen_vorgeben_writedata_call          (const uint8* const, Dcm_NegativeResponseCodeType* const, uint8_t (*api_dtms_diag_call)(const Dtms_diag_rdc_erfs_eco_neue_reifen_vorgeben_type_st*    const, uint8_t*));
