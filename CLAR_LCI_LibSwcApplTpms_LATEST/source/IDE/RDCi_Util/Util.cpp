...
#ifdef _EcuVirtual
long ReadLongIntFromStream(void)
{
   return 0;
}
#else
...
#ifdef _EcuVirtual
long long ReadLongLongIntFromStream(void)
{
   return 0;
}
#else
...
#ifdef _EcuVirtual
double ReadDoubleFromStream(void)
{
   return 0;
}
#else
...
#ifdef _EcuVirtual
void ReadCompleteLineFromStream(void)
{
#else
